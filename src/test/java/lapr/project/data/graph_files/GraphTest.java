...
public class GraphTest {
    ...
    public void testOutgoingEdges() {
        ...
        instance.vertices().forEach(vertices::add);

        assertTrue(vertices.contains("X"));

        instance.removeVertex("X");
        List<String> vertices2 = new ArrayList<String>();
        instance.vertices().forEach(vertices2::add);

        assertTrue(!vertices2.contains("X"));
        ...
        itEdge = instance.outgoingEdges("E").iterator();
        assertTrue((itEdge.hasNext()==false));
        assertTrue(instance.insertVertex(null));
    }
