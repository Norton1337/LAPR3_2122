...
class GraphAlgorithmsTest {
    ...
    /**
     * Test of BreadthFirstSearch method, of class GraphAlgorithmsMap.
     */
    @Test
    public void testBreadthFirstSearch() {
        System.out.println("Test BreadthFirstSearch");

        assertTrue(GraphAlgorithmsMap.BreadthFirstSearch(completeMap, "LX")==null, "Should be null if vertex does not exist");

        LinkedList<String> path = GraphAlgorithmsMap.BreadthFirstSearch(incompleteMap, "Faro");
        ...
        path = GraphAlgorithmsMap.BreadthFirstSearch(incompleteMap, "Porto");
        assertTrue(path.size()==7, "Should give seven vertices ");

        path = GraphAlgorithmsMap.BreadthFirstSearch(incompleteMap, "Viseu");
        assertTrue(path.size()==3, "Should give 3 vertices");
    }

    /**
     * Test of DepthFirstSearch method, of class GraphAlgorithmsMap.
     */
    @Test
    public void testDepthFirstSearch() {
        ...
        assertTrue(GraphAlgorithmsMap.DepthFirstSearch(completeMap, "LX")==null, "Should be null if vertex does not exist");

        path = GraphAlgorithmsMap.DepthFirstSearch(incompleteMap, "Faro");
        assertTrue(path.size()==1, "Should be just one");

        Iterator<String> it = path.iterator();
        assertTrue(it.next().compareTo("Faro")==0, "it should be Faro");

        path = GraphAlgorithmsMap.DepthFirstSearch(incompleteMap, "Porto");
        assertTrue(path.size()==7, "Should give seven vertices ");

        path = GraphAlgorithmsMap.DepthFirstSearch(incompleteMap, "Viseu");
        assertTrue(path.size()==3, "Should give 3 vertices");
    ...
    /**
     * Test of allPaths method, of class GraphAlgorithmsMap.
     */
    @Test
    public void testAllPaths() {
        ...
        paths=GraphAlgorithmsMap.allPaths(completeMap, "Porto", "LX");
        assertTrue(paths==null, "There should not be paths if vertex does not exist");

        paths = GraphAlgorithmsMap.allPaths(incompleteMap, "Porto", "Lisboa");
        assertTrue(paths.size()==4, "There should be 4 paths");

        paths=GraphAlgorithmsMap.allPaths(incompleteMap, "Porto", "Faro");
        assertTrue(paths.size()==0, "There should not be paths between Porto and Faro in the incomplete map");
    }

    /**
     * Test of shortestPath method, of class GraphAlgorithmsMap.
     */
    @Test
    public void testShortestPath() {
        ...
        double lenpath=0;
        lenpath=GraphAlgorithmsMap.shortestPath(completeMap,"Porto","LX",shortPath);
        assertTrue(lenpath == 0, "Length path should be 0 if vertex does not exist");

        lenpath=GraphAlgorithmsMap.shortestPath(incompleteMap,"Porto","Faro",shortPath);
        assertTrue(lenpath == 0, "Length path should be 0 if there is no path");

        lenpath=GraphAlgorithmsMap.shortestPath(completeMap,"Porto","Porto",shortPath);
        assertTrue(shortPath.size() == 1, "Number of nodes should be 1 if source and vertex are the same");

        lenpath=GraphAlgorithmsMap.shortestPath(incompleteMap,"Porto","Lisboa",shortPath);
        ...
        lenpath=GraphAlgorithmsMap.shortestPath(incompleteMap,"Braga","Leiria",shortPath);
        ...
        shortPath.clear();
        lenpath=GraphAlgorithmsMap.shortestPath(completeMap,"Porto","Castelo Branco",shortPath);
    ...
    /**
     * Test of shortestPaths method, of class GraphAlgorithmsMap.
     */
    @Test
    public void testShortestPaths() {
        ...
        GraphAlgorithmsMap.shortestPaths(completeMap,"Porto",paths,dists);
        ...
        assertEquals(Arrays.asList("Porto","Aveiro","Leiria","Castelo Branco"), paths.get(completeMap.getKey("Castelo Branco")), "Path to Castelo Branco");



        GraphAlgorithmsMap.shortestPaths(incompleteMap,"Porto",paths,dists);
        ...
        GraphAlgorithmsMap.shortestPaths(incompleteMap,"Braga",paths,dists);
